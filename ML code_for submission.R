...
kind_of_system <- params$kind_of_system   # 0 : ELISA, 1 : AI-QUANTA
...
tdata$stats <- factor(tdata$stats, levels = c(0,1), labels = c("Class0", "Class1"))
tdata <- cbind(sample_no = seq(1:150), tdata)
...
df_para <- data.frame (
  ...
  kind_of_system = kind_of_system,   # 0 : ELISA, 1 : QLFA
